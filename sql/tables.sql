...
id integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
addr_type address_type NOT NULL,
value_type field_value_type DEFAULT 'single' NOT NULL, -- FIXME not 100% on whether this is necessary, I think it is
addr_field text NOT NULL,
curator_note text,
